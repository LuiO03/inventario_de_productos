...
function registrarEventoLuces() {
  ...
  if (footerContent && darkToggle && modoIcono && modoTexto) {
    ...
    const actualizarEstadoLuces = () => {
      ...
      document.documentElement.classList.toggle("light-mode", activado);

      // ✅ GUARDA EN LOCALSTORAGE
      localStorage.setItem("theme", activado ? "light" : "dark");
    ...
    const debeSerClaro = temaGuardado === "light";
    darkToggle.checked = debeSerClaro;
