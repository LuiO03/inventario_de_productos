...
<div class="contenedor-header">
    <h1>Agregar Rol</h1>
    <p>Aquí puedes agregar un nuevo rol para los usuarios del sistema.</p>
</div>

<form action="<?= BASE_URL ?>rol/store" method="post" class="formulario" autocomplete="off">
        ...
        <div class="formulario-columna">
            ...
            <div class="input-group">
                ...
                <div class="input-contenedor">
                    ...
                    <input type="text" id="nombre" name="nombre" required placeholder="Ingrese el nombre del rol" value="<?= htmlspecialchars($old['nombre'] ?? '') ?>">
            ...
            <div class="input-group">
                ...
                <div class="input-contenedor">
                    ...
                    <textarea id="descripcion" name="descripcion" rows="3" placeholder="Describe brevemente el rol..."><?= htmlspecialchars($old['descripcion'] ?? '') ?></textarea>
